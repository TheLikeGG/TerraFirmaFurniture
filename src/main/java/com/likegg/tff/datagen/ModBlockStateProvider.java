...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void registerCounterModel(Block block, String name, ResourceLocation topTexture, ResourceLocation bodyTexture) {
    ...
    private void registerCounterVariants(Map<Wood, DeferredBlock<Block>> map, String name, String topTexture, String bodyTexture){
        // Basic counters
    ...
    private void registerCabinets(Map<Wood, DeferredBlock<Block>> map, String name, String baseTexture, String bodyTexture, String modelName){
        map.forEach((wood, block) -> {
            String woodName = wood.getSerializedName();
            ...
            ResourceLocation logTexture = ResourceLocation.fromNamespaceAndPath("tfc", bodyTexture + woodName);
    ...
    private void registerShelf(Map<Wood, DeferredBlock<Block>> map, String name, String baseTexturePath, String shelfTexturePath, String logTexturePath) {
        map.forEach((wood, block) -> {
            String woodName = wood.getSerializedName();
    ...
    private void registerNightStands(Map<Wood, DeferredBlock<Block>> map, String name, String baseTexturePath, String topTexturePath, String modelPath){
        map.forEach((wood, block) -> {
            String woodName = wood.getSerializedName();
