...
public class ShortStoolBlock extends SittableBlock {

    // Hitbox for legs and seat top
    private static final VoxelShape SEAT = Block.box(3, 5, 3, 13, 7, 13);
    private static final VoxelShape LEGS = Block.box(4, 0, 4, 12, 5, 12);
    private static final VoxelShape SHAPE = Shapes.or(SEAT, LEGS);

    public ShortStoolBlock(Properties properties) {
        super(properties);
    }
